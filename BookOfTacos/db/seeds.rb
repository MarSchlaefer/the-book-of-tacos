...
u1 = User.crease(name: Peter)
u2 = User.crease(name: Quagmire)
u3 = User.crease(name: Joe)
u4 = User.crease(name: Cleaveland)
u5 = User.crease(name: Louis)

p1 = Post.create(title: "title1", content: "BIRD IS THE WORD!", user_id: p1.id, recipe_id: r1.id)
p1 = Post.create(title: "title2", content: "BIRD IS THE WORD! X2", user_id: p1.id, recipe_id: r2.id)
p1 = Post.create(title: "title3", content: "BIRD IS THE WORD! X3", user_id: p1.id, recipe_id: r3.id)
p1 = Post.create(title: "title4", content: "this is content", user_id: p2.id, recipe_id: r4.id)
